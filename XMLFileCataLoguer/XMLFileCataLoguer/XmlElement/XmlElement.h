...
* --------------------
* ver 1.6 : 30 Mar 15
* - add return children and move constructor, tag to string sel closing version.
* ver 1.5 : 22 Feb 15
...
namespace XmlProcessing
{
  ...
  public:
	...
	virtual std::vector<std::shared_ptr<AbstractXmlElement>>& children(){ return nullchildren; }
	virtual std::vector<std::pair<std::string, std::string>>& attributes(){ return nullattribs; }
    virtual std::string value() = 0;
    virtual std::string toString() = 0;
	virtual std::string tag() { return " "; }
    virtual ~AbstractXmlElement();
  protected:
	static std::vector<std::shared_ptr<AbstractXmlElement>> nullchildren;
	static std::vector<std::pair<std::string, std::string>> nullattribs; 
    static size_t count;
  ...
  std::shared_ptr<AbstractXmlElement> moveDocElement(DocElement& de);
  std::shared_ptr<AbstractXmlElement> moveDocElement(std::shared_ptr<AbstractXmlElement> de);
  ...
  std::shared_ptr<AbstractXmlElement> moveTextElement(std::shared_ptr<AbstractXmlElement> te);
  std::shared_ptr<AbstractXmlElement> moveTextElement(TextElement& te);
  ...
  public:
	...
	TaggedElement(TaggedElement&& te);
    ...
    virtual bool addAttrib(const std::string& name, const std::string& value);
    virtual bool removeAttrib(const std::string& name);
	std::vector<std::shared_ptr<AbstractXmlElement>>& children(){ return children_; }
	std::vector<std::pair<std::string, std::string>>& attributes(){ return attribs_; }
    virtual std::string value();
    virtual std::string toString();
  ...
  public:
	...
	CommentElement(CommentElement&& ce);
	CommentElement& operator = (CommentElement&& ce);
  ...
  public:
	...
	ProcInstrElement(ProcInstrElement&& pe);
	ProcInstrElement& operator=(ProcInstrElement&& pe);
  ...
  public:
	...
	XmlDeclarElement(XmlDeclarElement&& xe);
	XmlDeclarElement& operator=(XmlDeclarElement&& xe);
    virtual bool addAttrib(const std::string& name, const std::string& value);
    virtual bool removeAttrib(const std::string& name);
	virtual std::vector<std::pair<std::string, std::string>>& attributes(){ return attribs_; }
